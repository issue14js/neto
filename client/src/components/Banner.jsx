    ...
    return (
        ...
        >
            <div className="relative z-10 flex max-w-sm flex-1 flex-col justify-center">
                ...
                <button
                    type="button"
                    className={`mt-3 w-fit rounded-full px-4 py-2 text-xs font-bold shadow-sm transition-transform hover:-translate-y-0.5 ${
                        isDark
            ...
            <img
                ...
                className="absolute bottom-0 right-[2%] h-[100%] w-[50%] max-w-[300px] object-contain object-bottom"
            />
        </section>
    );
};
