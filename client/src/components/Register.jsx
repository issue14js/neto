  ...
  return (
    <div className={`h-screen flex justify-center items-center w-full `}>
        <form className={`h-100  p-5 rounded-2xl w-70 bg-zinc-800 ${themeStyles}`} onSubmit={handelSubmit}>
            ...
            <input maxLength={8} className="border-white w-full mb-2 border rounded p-2 text-white outline-none" type="text" placeholder="Enter Username" name="username" onChange={handelChange} />
            <span className="block text-white">Password</span>
            <input minLength={6} className="border-white mb-2 w-full block border rounded p-2 text-white outline-none" type="password" placeholder="Enter Password" name="password" onChange={handelChange} />
