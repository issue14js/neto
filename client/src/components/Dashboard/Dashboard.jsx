...
const Dashboard = ({onViewNote,setShowCreateNote,setOwner,showCreateNote, setviewNote,setnoteId,themeStyles}) => {
    ...
    return (
        <div className={`grid h-screen w-full grid-cols-1 grid-rows-[25%_auto_7%] 
            ...
            <NavbarDashboard  themeStyles={themeStyles} setOwner={setOwner} onViewNote={()=> {setviewNote(true)}} setnoteId={setnoteId} />
